...
type Act = (dialogue: Dialogue, repository: BattleRepository) => (battle: Battle, actor: CharactorBattling, doSkillForm: DoSkillForm, lastTurn: Turn) => Promise<null | DataNotFoundError | ReceiverDuplicationError | UserCancel>;
const act: Act = async (dialogue, repository) => (battle, actor, doSkillForm, lastTurn) => {
